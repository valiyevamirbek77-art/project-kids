...
const offerse = [
    {
        ...
        vapni: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod <br><br> incididunt ut labore et dolore magna aliqua.",
...
class LatestBlog {
    ...
    render() {
        ...
        card1.innerHTML = `
            ...
            <div class="content">
                <p>By, <span style="color:#e91e63;">${this.blog1.author}</span></p>
        ...
        card2.innerHTML = `
            ...
            <div class="content">
                <p>By, <span style="color:#e91e63;">${this.blog2.author}</span></p>
        ...
        card3.innerHTML = `
            ...
            <div class="content">
                <p>By, <span style="color:#e91e63;">${this.blog3.author}</span></p>
